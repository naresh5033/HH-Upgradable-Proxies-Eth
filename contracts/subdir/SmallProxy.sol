    ...
    contract SmallProxy is Proxy {
        ...
        //helper fn to read the storage at slot[0]
        ...
        {
            assembly {
                valueAtStorageSlotZero := sload(0) // set it to the sotraslot 0 / Readin directly from the storage
            }
        }
    }
    // Anytime someone calls the smallProxy contract, the smallproxy is gon delegate call to the implA and then saves the storage in our small proxy addr
